  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-10">
      <div className="w-full max-w-lg p-6 bg-white shadow-xl rounded-lg">
        <h2 className="text-2xl font-semibold text-center text-red-600 mb-5">Comment Section</h2>
        ...
        <button
          ...
          className="w-full bg-red-500 text-white p-3 rounded-md hover:bg-red-600 transition-all"
        >
          Post Comment
        </button>
      </div>
          ...
          {comments.map((commentData, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <p className="font-bold text-red-500">{commentData.username}:</p>
                <button
